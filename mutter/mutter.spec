%global commit f254f17434436488b7a9088af7666af1e8cd22f4
...
Name:          mutter
Version:       40.0
Release:       git%{build_time}.patched%{?dist}
Summary:       Window and compositing manager based on Clutter

License:       GPLv2+
URL:           http://www.gnome.org
Source0:       https://gitlab.gnome.org/GNOME/mutter/-/archive/%{commit}/%{name}-%{commit}.tar.gz
...
# https://gitlab.gnome.org/GNOME/mutter/-/merge_requests/1845
